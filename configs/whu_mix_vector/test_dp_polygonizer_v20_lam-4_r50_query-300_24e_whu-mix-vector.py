...
default_hooks = dict(
    ...
    visualization=dict(type='TanmlhVisualizationHook', draw=True, interval=200000)
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            project = 'mmdetection',
            entity = 'tum-tanmlh',
            name = 'test_polygonizer_no-clamp_mask-targets_v20_sample-points_v2_align-iou-05_lam-4_r50_query-300_24e_whu-mix-vector',
            resume = 'never',
            dir = './work_dirs/',
