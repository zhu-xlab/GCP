...
val_evaluator = [
    ...
    dict(
        ...
        # ann_file='../../Datasets/Dataset4EO/WHU-Mix/val/val-small.json',
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            project = 'mmdetection',
            entity = 'tum-tanmlh',
            name = 'polygonizer_v19_lam-4_r50_query-300_12e_whu-mix-vector',
            resume = 'never',
            dir = './work_dirs/',
