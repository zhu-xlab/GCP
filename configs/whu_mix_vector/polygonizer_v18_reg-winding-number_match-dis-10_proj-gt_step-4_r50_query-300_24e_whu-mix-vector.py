...
load_from='work_dirs/mask2former_r50_query-300_24e_whu-mix-vector/epoch_24.pth'
...
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=max_epochs, val_interval=24)
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            project = 'mmdetection',
            entity = 'tum-tanmlh',
            name = 'test_polygonizer_v18_reg-winding-number_match-dis-10_proj-gt_step-4_r50_query-300_24e_whu-mix-vector',
            resume = 'never',
            dir = './work_dirs/',
