...
default_hooks = dict(
    ...
    visualization=dict(type='TanmlhVisualizationHook', draw=True, interval=100000)
)
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            project = 'mmdetection',
            entity = 'tum-tanmlh',
            name = 'test_polygonizer_v12_reg-contour_ind-offset_pred-angle_step-8_freeze_r50_80k_whu-mix-vector',
            resume = 'never',
            dir = './work_dirs/',
