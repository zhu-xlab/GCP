...
load_from='work_dirs/mask2former_r50_query-300_24e_crowd_ai/epoch_24.pth'
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            project = 'mmdetection',
            entity = 'tum-tanmlh',
            name = 'polygonizer_v8_right-angle_fixed-step_freeze_r50_80k_crowd_ai',
            resume = 'never',
            dir = './work_dirs/',
