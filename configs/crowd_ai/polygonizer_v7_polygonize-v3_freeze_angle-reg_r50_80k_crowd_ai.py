...
load_from='work_dirs/mask2former_r50_query-300_24e_crowd_ai/epoch_10.pth'
...
model = dict(
    ...
    panoptic_head=dict(
        ...
        poly_cfg=dict(
            ...
            poly_inter_type='fixed_length',
            init_poly_type='polygonized_v3',
            polygonized_scale=1.,
            max_offsets=10,
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            project = 'mmdetection',
            entity = 'tum-tanmlh',
            name = 'polygonizer_v7_freeze_angle-reg_r50_80k_crowd_ai',
            resume = 'never',
            dir = './work_dirs/',
