...
# load_from='work_dirs/mask2former_r50_8xb2-lsj-50e_crowd_ai/iter_80000.pth'
load_from='work_dirs/mask2former_r50_query-300_24e_crowd_ai/epoch_6.pth'
...
model = dict(
    ...
    panoptic_head=dict(
        ...
        num_inter_points=128,
        num_queries=100,
        num_primitive_queries=32,
        num_transformer_feat_level=3,
        max_offsets=10,
        interpolate_type='fixed_interval',
        interpolate_interval=2,
        # interpolate_type='fixed_length',
        pixel_decoder=dict(
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            project = 'mmdetection',
            entity = 'tum-tanmlh',
            name = 'polygonizer_v3_r50_80k_crowd_ai',
            resume = 'never',
            dir = './work_dirs/',
...
train_dataloader = dict(
    dataset=dict(
        ann_file='8e089a94-555c-4d7b-8f2f-4d733aebb058_train/train/annotation-small.json',
    )
)
