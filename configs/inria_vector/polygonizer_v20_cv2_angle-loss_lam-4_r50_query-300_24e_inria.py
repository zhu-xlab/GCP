...
model = dict(
    ...
    test_cfg=dict(
        ...
        stride=(400, 400), scale_factor=4,
        crop_size=(512, 512), crop_up_size=(512, 512),
        out_size_scale=1, out_crop_size=(512, 512)
    ),
    init_cfg=None)
...
vis_backends = [
    dict(
        ...
        init_kwargs=dict(
            project = 'mmdetection',
            entity = 'tum-tanmlh',
            name = 'polygonizer_v20_cv2_angle-loss_lam-4_r50_query-300_24e_inria',
            resume = 'never',
            dir = './work_dirs/',
